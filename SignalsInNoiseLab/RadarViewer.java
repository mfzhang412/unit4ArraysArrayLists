...
public class RadarViewer
{
    ...
    public static void main(String[] args) throws InterruptedException
    {
        ...
        System.out.print("Would you like to manually set the location of the monster (y/n): ");
        String yn = s.next();
        
        if (yn.equals("y"))
        {
            System.out.print("Enter in the monster's row: ");
            int userRow = s.nextInt();
            
            System.out.print("Enter in the monster's col: ");
            int userCol = s.nextInt();
            
            Radar radar = new Radar(ROWS, COLS, userRow, userCol);
